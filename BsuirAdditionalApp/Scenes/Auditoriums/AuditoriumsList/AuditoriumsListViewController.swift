...
class AuditoriumsListViewController: UIViewController {
  ...
  override func viewDidLoad() {
    ...
    navigationItem.title = "Результат поиска".localized
...
extension AuditoriumsListViewController: UITableViewDelegate, UITableViewDataSource {
  ...
  func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
    guard let cell = tableView.dequeueReusableCell(withIdentifier: "auditoriumCell", for: indexPath) as? AuditoriumListTableViewCell else {
